...
+ (DTLoupeView *)sharedLoupe
{
    ...
    //    }
    //
    //    if ([self loupeWindow].rootViewController != viewController) {
    //        [self loupeWindow].rootViewController = viewController;
    //    }
...
- (UIWindow *)loupeWindow
{
    ...
    if (self.lWindow == nil) {
        self.lWindow = [[UIWindow alloc] initWithFrame:mainWindow.bounds];
        [self.lWindow addSubview:self];
    }
    ...
    self.lWindow.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    self.lWindow.rootViewController = viewController;
    self.lWindow.hidden = NO;
    self.lWindow.userInteractionEnabled = NO;
    self.lWindow.windowLevel = UIWindowLevelAlert;
...
- (id)init
{
    ...
    if (self)
    {
        ...
        //[[self loupeWindow] addSubview:self];
...
{
    UIWindow *loupeWindow = [self loupeWindow];
...
- (void)setTouchPoint:(CGPoint)touchPoint
{
    ...
    CGPoint convertedLocation = [[self loupeWindow] convertPoint:pointInWindow fromWindow:_targetView.window];
...
- (void)presentLoupeFromLocation:(CGPoint)location
{
    ...
    // calculate transform
    CGPoint convertedLocation = [_targetView convertPoint:location toView:[self loupeWindow]];
