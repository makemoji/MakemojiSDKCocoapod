...
- (UIImageView *)dragHandleLeft
{
	if (!_dragHandleLeft)
	{
		...
		_dragHandleLeft.image = [UIImage imageNamed:@"DTLoupe.bundle/kb-drag-dot.png" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
...
- (UIImageView *)dragHandleRight
{
	if (!_dragHandleRight)
	{
		...
		_dragHandleRight.image = [UIImage imageNamed:@"DTLoupe.bundle/kb-drag-dot.png" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
